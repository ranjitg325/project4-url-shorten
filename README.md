...
## Phase II
- Use caching while creating the  url to minimize db calls.
- Implement what makes sense to you and weshortened will build understanding over the demo discussion. 
